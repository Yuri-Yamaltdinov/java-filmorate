                ...
                .hasValueSatisfying(film ->
                        assertThat(film).hasFieldOrPropertyWithValue("id", 1)
                                .hasFieldOrPropertyWithValue("mpa", Mpa.builder()
                                        ...
                                        .name("G")
                                        .build())
                                .hasFieldOrPropertyWithValue("title", "film")
                ...
                .hasValueSatisfying(film ->
                        assertThat(film).hasFieldOrPropertyWithValue("id", 1)
                                .hasFieldOrPropertyWithValue("mpa", Mpa.builder()
                                        ...
                                        .name("PG")
                                        .build())
                                .hasFieldOrPropertyWithValue("title", "update film")
                ...
                .hasValueSatisfying(films ->
                        assertThat(films.get(1)).hasFieldOrPropertyWithValue("id", 2)
                                .hasFieldOrPropertyWithValue("mpa", Mpa.builder()
                                        ...
                                        .name("PG-13")
                                        .build())
                                .hasFieldOrPropertyWithValue("title", "film test 2")
                ...
                .hasValueSatisfying(films ->
                        assertThat(films.get(2)).hasFieldOrPropertyWithValue("id", 3)
                                .hasFieldOrPropertyWithValue("mpa", Mpa.builder()
                                        ...
                                        .name("R")
                                        .build())
                                .hasFieldOrPropertyWithValue("title", "film test 3")
